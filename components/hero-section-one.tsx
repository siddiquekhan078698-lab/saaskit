                            ...
                            <div className="md:w-1/2">
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Button size="lg" className="pr-4.5" render={<Link href="#link" />} nativeButton={false}><span className="text-nowrap">Get Started</span><ChevronRight className="opacity-50" /></Button>
                                        <Button key={2} size="lg" variant="outline" className="pl-5" render={<Link href="#link" />} nativeButton={false}><CirclePlay className="fill-primary/25 stroke-primary" /><span className="text-nowrap">Watch video</span></Button>
                                    </div>
                                </div>
